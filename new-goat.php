...
<div class="card m-auto mt-6 text-center p-8 flex-shrink-0 w-full max-w-sm bg-gradient-to-r from-red-400 to-red-700">
    <form method="POST" >
        <!--  firstname -->
        <div class="form-control  ">
            ...
            <input type="text" placeholder="Type here" class="input input-bordered w-64 " name="prenom" id ="prenom" />
        ...
        <div class="form-control">
            ...
            <input type="text" placeholder="Type here" class="input input-bordered w-64" name="nom" id ="nom" />
        ...
        <div class="form-control  ">
            ...
            <label class="input-group">
                <span>Année</span>
            <input type="number" placeholder="" class="input input-bordered w-64" name="age" id ="age" />
        ...
        <div class="form-control">
            ...
            <input type="text" placeholder="Text-here" class="input input-bordered w-64 "  />
            </label>
        ...
        <!-- btn submit -->
        <input type="submit" class="btn btn-active bg-red-500 mt-5 font-black" name="submitted" value="envoyer"   >
    </form>
</div>
